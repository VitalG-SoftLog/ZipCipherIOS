/*
 *  This modified FIPS-180-1 compliant SHA-1 implementation based on 
 *  Joined copyright of Paul Bakker on original XySSL code with: Christophe Devine
 ...
 * SHA-1 final digest
 */
void sha1_final( sha1_ctx *ctx, unsigned char output[20] )
{
...
void sha1_hmac_final( sha1_ctx *ctx, unsigned char output[20] )
{
